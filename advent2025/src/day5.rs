...
fn test_part1_answers(#[case] path: &str, #[case] expected_fresh_items: u64) {
    // Act
...
fn test_part2_answers(#[case] path: &str, #[case] expected_fresh_items: u64) {
    // Act
